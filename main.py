...
def parse_args_and_config():
    ...
    parser.add_argument('--runner', type=str, default='StockRunner', help='The runner to execute')
    parser.add_argument('--config', type=str, default='stock.yml',  help='Path to the config file')
    ...
    # stock parameters
    parser.add_argument('--train_data_dir', type=str, default='data/train.csv', help="Path for stock datasets")
    parser.add_argument('--val_data_dir', type=str, default='data/val.csv', help="Path for stock datasets")
    parser.add_argument('--test_data_dir', type=str, default='data/test.csv', help="Path for stock datasets")
...
def main():
    ...
    try:
        ...
        if not args.test:
            ...
            predictions = runner.test_inpainting()
            # save csv
